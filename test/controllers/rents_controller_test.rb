...
class RentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rent" do
    assert_difference('Rent.count') do
      post rents_url, params: { rent: { cassette_id: @rent.cassette_id, end_rent: @rent.end_rent, member_id: @rent.member_id, start_rent: @rent.start_rent } }
    end
  ...
  test "should update rent" do
    patch rent_url(@rent), params: { rent: { cassette_id: @rent.cassette_id, end_rent: @rent.end_rent, member_id: @rent.member_id, start_rent: @rent.start_rent } }
